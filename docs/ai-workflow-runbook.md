# AI Workflow Runbook (Detailed)

This document is the **detailed, human-oriented runbook** for the repo’s AI workflow. It includes the full step-by-step procedures and example `gh` / `git` commands.

The **agent-facing, token-efficient contract** lives in `templates/AGENTS.md`.

---

## Source

This file preserves the previous, long-form workflow instructions that were formerly embedded in `templates/AGENTS.md`.

If you update this runbook, keep `templates/AGENTS.md` minimal and treat this file as the canonical location for verbose examples and troubleshooting.

---

## Full workflow (previous long-form instructions)

> Note: This is intentionally verbose. The agent contract references this file rather than embedding it.

<!-- ai-workflow-runbook:start -->
